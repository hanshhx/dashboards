  ...
  return (
    <div className="flex min-h-screen">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        <header className="h-16 shrink-0 flex items-center gap-3 px-4 md:px-6 border-b border-slate-200 dark:border-white/10 bg-white dark:bg-[#10111a] sticky top-0 z-20">
