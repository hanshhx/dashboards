...
- 입문 문제를 100개(3지선다·상세 해설)로 보강 완료. 이로써 학습 콘텐츠 3단계가 모두 채워짐 — 학습 항목 74개, 문제 304개(입문 18항목·100문제, 기초 24항목·104문제, 심화 32항목·100문제). 단계 시험은 무작위 20문항 중 80% 이상 통과 시 다음 단계 해금. 보기 수는 입문 3·기초 4·심화 5지선다로 통일.
